...
<html lang="en">
   <head>
      ...
      <title>Escalation Matrix | My Record</title>
   </head>
   <body>
                           ...
                           <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                              ...
                              <tbody>
                                 ...
                                 <tr class="odd gradeX">
                                    ...
                                    <td><?php echo $row['OOName'];?></td>
                                    <td><?php echo $row['BMName'];?></td>
                                    <td><?php echo $row['SDMName'];?></td>
                                    <td><?php echo $row['AMName'];?></td>
                                    <td><?php echo $row['ADName'];?></td>
                                    <td><?php echo $row['DName'];?></td>
                                    <td class="center">
                                       <a href="editinfo.php?id=<?php echo $row['id'];?>">
                                          <i class="fa fa-edit " style="color:#6666FF;"></i>
                                       </a>
                                    </td>
                                 </tr>
                                 <?php $cnt=$cnt+1;} ?>                                      
