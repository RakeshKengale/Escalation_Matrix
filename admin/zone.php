...
<?php
   ...
   $sql="INSERT INTO tblzone(Zonename) VALUES(:zone)";
   ...
   if($lastInsertId)
   {
      echo"<script>alert('Zone Added Successfully');document.location = 'zone.php';</script>";
   }
   else 
   {
   	   echo"<script>alert('Something went wrong. Please try again');document.location = 'zone.php';</script>";
                     ...
                     <div class="col-lg-12" style="padding-bottom: 1%; padding-top:1%; padding-left: 5%; padding-right: 5%;">
                        <div class="col-md-6 col-lg-12">
                           <form  method="post">
                              ...
                              <div class="container">
                                 <button type="submit" name="addzone" class="btn btn-success btn-lg">Submit</button>
                                 <br >
                              </div>
                           </form>
                        </div>
                              ...
                              <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                 ...
                                 <tbody>
                                    ...
                                    <tr class="odd gradeX">
                                       ...
                                       <td class="center">
                                          <a href="edit_zone.php?zoneid=<?php echo htmlentities($result->Zoneid);?>"><button class="btn btn-primary btn-xs"><i class="fa fa-edit "></i> Edit</button> 
                                       </td>
                                    </tr>
                                    <?php $cnt=$cnt+1;}} ?>                                      
                                 </tbody>
