                     ...
                     <div class="panel-body">
                        <div class="table-responsive">
                           <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                              ...
                              <tbody>
                                 <?php
                                    $sql=mysqli_query($dbh,"SELECT *  FROM tblinfo WHERE Hide=2");
                                    $cnt=1;
                                 ...
                                 <tr class="odd gradeX">
                                    ...
                                    <td class="center">
                                      <button type="button" class="btn btn-success btn-lg"><a href="dashboard.php?id=<?php echo $row['id']?>&up=Sync" onClick="return confirm('Data Sync Done...!')"><i class="fa fa-refresh" style="color:#FFFFFF;"> Sync Info</i></a> </button>				   
									 </td>
                                 </tr>
                                 <?php $cnt=$cnt+1;} ?>                                      
                              </tbody>
